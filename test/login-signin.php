    ...
    <div class="col-sm-5 mb-3 mb-sm-0">
      <div class="card bord">
        <div class="card-body text-center">
          ...
          <form>
            <div class="mb-3">
              <input class="rounded col-9" type="text" name="u" placeholder="Username" required>
            </div>
            <div class="mb-3">
              <input class="rounded col-9" type="password" name="p" placeholder="Password" required="required" />
            </div>
            <div>
