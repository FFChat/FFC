  ...
  <div class="row align-items-center justify-content-center text-center" style="min-height: 85vh">
      <div class="col-6 x">
        <h1 class="text-white">Login</h1>
          <form>
            <div class="mb-3"><input type="text" name="u" placeholder="Username" required="required"/></div>
            <!-- <div class="mb-3"><input type="password" name="p" placeholder="Password" required="required"/></div> -->
            <div><button type="submit" class="btn btn-primary btn-block btn-large">Come in.</button></div>
          </form>
      </div>
  </div>
</div>
